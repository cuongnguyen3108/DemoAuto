...
public class InventoryPage extends BasePage {
    ...
    public List<Product> addProductToCart(String quantity) {
        ...
        WebElement sortProduct = WaitElement.clickable(driver, By.xpath(firstRow.get("element_selectSort")), 5);
        Select selectSort = new Select(sortProduct);
        selectSort.selectByValue(firstRow.get("selectSort"));

        List<WebElement> listProduct = WaitElement.visibleElements(driver, By.xpath(firstRow.get("element_listProduct")), 10);
        ...
        for (Map<String, String> data : excelData) {
            ...
            for (int i = 0; i < q; i++) {
                ...
                WebElement addToCartProduct = listProduct.get(i).findElement(By.xpath(firstRow.get("element_addToCartProduct")));
                addToCartProduct.click();
                WebElement nameProduct = listProduct.get(i).findElement(By.xpath(firstRow.get("element_nameProduct")));
                System.out.println("Name Product: " + nameProduct.getText());
                product.setProductName(nameProduct.getText());
                WebElement priceProduct = listProduct.get(i).findElement(By.xpath(firstRow.get("element_priceProduct")));
